      ...
      <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6 pt-1 sm:pt-2">
          ...
          <Link
            ...
            className="group relative flex flex-col justify-between p-5 sm:p-6 md:p-7 rounded-2xl bg-gradient-to-br from-[#4D7324] via-[#3D5E1C] to-[#2E4814] text-white shadow-sm hover:shadow-lg active:scale-[0.98] transition-all duration-200 text-left border border-[#5E8A2C]/60 hover:border-[#86B84A] hover:-translate-y-0.5 overflow-hidden min-h-[215px] sm:min-h-[235px] md:min-h-[250px] cursor-pointer touch-manipulation"
          >
            {/* Ambient Radial Sheen */}
            <div className="absolute top-0 right-0 -mt-10 -mr-10 w-44 h-44 rounded-full bg-white/10 blur-2xl group-hover:scale-125 group-hover:bg-white/15 transition-all duration-500 pointer-events-none" />

            <div className="space-y-3 sm:space-y-3.5 relative z-10">
              
              {/* Header Icon & Category Badge */}
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-white/20 backdrop-blur-md border border-white/30 text-white flex items-center justify-center shadow-xs transition-all duration-200 group-hover:bg-white group-hover:text-[#35551F]">
              ...
              {/* Title & Description */}
              <div>
                <h2 className="text-[20px] sm:text-[24px] font-black text-white leading-tight">
                  {t.enterWorker}
                </h2>
            ...
            <div className="pt-3 sm:pt-3.5 mt-3 sm:mt-3.5 flex items-center justify-between border-t border-white/20 text-[12.5px] sm:text-[13.5px] font-bold relative z-10">
              ...
              {/* Action Arrow Button */}
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white text-[#35551F] flex items-center justify-center shadow-xs transition-all duration-200 group-hover:translate-x-1 group-active:scale-95">
          ...
          <Link
            ...
            className="group relative flex flex-col justify-between p-5 sm:p-6 md:p-7 rounded-2xl bg-white hover:bg-[#FAF7F0] text-[#263026] shadow-sm hover:shadow-lg active:scale-[0.98] transition-all duration-200 text-left border border-[#E8E2D5] hover:border-[#5C822D] hover:-translate-y-0.5 overflow-hidden min-h-[215px] sm:min-h-[235px] md:min-h-[250px] cursor-pointer touch-manipulation"
          >
            {/* Ambient Soft Green Glow */}
            <div className="absolute top-0 right-0 -mt-10 -mr-10 w-44 h-44 rounded-full bg-[#5C822D]/5 blur-3xl group-hover:scale-125 group-hover:bg-[#5C822D]/10 transition-all duration-500 pointer-events-none" />

            <div className="space-y-3 sm:space-y-3.5 relative z-10">
              
              {/* Header Icon & Category Badge */}
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#EDF3E4] border border-[#C6DCC0] text-[#5C822D] flex items-center justify-center shadow-xs transition-all duration-200 group-hover:bg-[#5C822D] group-hover:text-white">
                  <BarChart3 className="w-6 h-6 sm:w-7 sm:h-7 stroke-2" />
                </div>

                <span className="text-[10px] sm:text-[11px] font-mono font-bold tracking-widest text-[#5C822D] bg-[#EDF3E4] px-2.5 py-0.5 rounded-full border border-[#C6DCC0] uppercase shadow-2xs group-hover:bg-[#5C822D] group-hover:text-white group-hover:border-[#5C822D] transition-colors duration-200">
                  {language === 'hi' 
                    ? 'एचएसई टीम' 
                    : language === 'kn'
                    ? 'HSE ತಂಡ'
              ...
              {/* Title & Description */}
              <div>
                <h2 className="text-[20px] sm:text-[24px] font-black text-[#263026] leading-tight group-hover:text-[#35551F] transition-colors duration-200">
                  {t.openDashboard}
                </h2>
            ...
            {/* Bottom Action Footer Bar */}
            <div className="pt-3 sm:pt-3.5 mt-3 sm:mt-3.5 flex items-center justify-between border-t border-[#E8E2D5] group-hover:border-[#C6DCC0] text-[12.5px] sm:text-[13.5px] font-bold relative z-10 transition-colors duration-200">
              ...
              {/* Action Arrow Button */}
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#FAF6EE] text-[#5C822D] flex items-center justify-center shadow-xs transition-all duration-200 group-hover:translate-x-1 group-hover:bg-[#5C822D] group-hover:text-white group-active:scale-95">
                <ArrowRight className="w-4 h-4 stroke-2" />
              </div>
            </div>
