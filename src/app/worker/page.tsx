    ...
    <div className="space-y-6">
      ...
      <div className="gov-card p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#E7E5DE] pb-4">
          <div>
            ...
            <h1 className="text-[22px] font-bold text-[#263026]">
          ...
          <div className="flex items-center gap-2">
            {activeShift?.status === ShiftStatus.ACTIVE ? (
              ...
              <span className="gov-badge gov-badge-neutral text-[12px]">
                NO ACTIVE SHIFT
              </span>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-[#FAFBF9] p-4 rounded-md border border-[#E7E5DE] flex items-center justify-between">
            <div>
              <div className="text-[12px] text-[#7A8178] font-medium">Shift Commencement:</div>
              <div className="font-bold text-[15px] text-[#263026]">
            ...
            {activeShift?.status === ShiftStatus.ACTIVE ? (
              <button
                onClick={() => endShift()}
                className="gov-btn-danger h-9 px-3 text-[13px]"
              >
              ...
              <button
                onClick={() => startShift()}
                className="gov-btn-primary h-9 px-3 text-[13px]"
              >
          ...
          <div className="bg-[#FAFBF9] p-4 rounded-md border border-[#E7E5DE] flex items-center justify-between">
            <div>
              <div className="text-[12px] text-[#7A8178] font-medium">Assigned Dosimeter:</div>
              <div className="font-bold text-[15px] text-[#263026]">
      ...
      <div className="gov-card p-6 text-center space-y-4">
        <div className="max-w-md mx-auto space-y-2">
          <h2 className="text-[18px] font-bold text-[#263026]">
        ...
        <div className="pt-2">
          <Link
            href="/worker/scan"
            className="gov-btn-primary h-11 px-8 text-[15px] font-semibold inline-flex items-center gap-2.5"
          >
